...
public class MultiConfigurationAdapter implements ConfigurationAdapter {
     ...
     */
    public MultiConfigurationAdapter(MultiPlugin plugin, List<ConfigurationAdapter> adapters) {
        this.plugin = plugin;
        this.adapters = ImmutableList.copyOf(adapters).reverse();
    }

    public MultiConfigurationAdapter(MultiPlugin plugin, ConfigurationAdapter... adapters) {
