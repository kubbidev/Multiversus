...
import me.kubbidev.multiversus.dependencies.classloader.IsolatedClassLoader;
...
public class DependencyManagerImpl implements DependencyManager {
    ...
    public DependencyManagerImpl(MultiPlugin plugin) {
    ...
    private static Path setupCacheDirectory(MultiPlugin plugin) {
