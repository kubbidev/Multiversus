package me.kubbidev.multiversus.messaging.rabbitmq;
...
public class RabbitMQMessenger implements Messenger {
    ...
    private static final String EXCHANGE = "multiversus";
    private static final String ROUTING_KEY = "multiversus:update";
    ...
    public RabbitMQMessenger(MultiPlugin plugin, IncomingMessageConsumer consumer) {
        this.plugin = plugin;
