...
public final class CaffeineFactory {
    ...
    /**
     * Our own fork join pool for Multiversus cache operations.
     * <p>
     ...
     * or otherwise block waiting for something else to complete. This prevents the Multiversus cache loading
